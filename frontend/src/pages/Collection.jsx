...
return (
  <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={()=>{
          setShowFilter(!showFilter)}} className='my-2 flex items-center cursor-pointer gap-2'>Filter
              ...
              <div className='flex flex-col text-sm font-light text-gray-700'>
                <p className='flex-gap-2'>
                  <input className="w-3"type="checkbox" value={'Topwear'}onChange={toggleSubCategory} /> Topwear</p>
                   <p className='flex-gap-2'>
                  <input className="w-3"type="checkbox" value={'Bottomwear'}onChange={toggleSubCategory} /> Bottemwear</p>
                   <p className='flex-gap-2'>
